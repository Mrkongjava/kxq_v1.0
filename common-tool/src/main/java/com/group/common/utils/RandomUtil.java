...
public class RandomUtil {
	...
	public static BigDecimal getRandomBigdecimal(BigDecimal max, BigDecimal min){
		...
		BigDecimal random = new BigDecimal(String.valueOf(Math.random()));

		BigDecimal db1 = random.multiply(max.subtract(min));
		BigDecimal db2 = db1.add(min);

		BigDecimal result = db2.setScale(2, BigDecimal.ROUND_HALF_UP);// 保留2位小数并四舍五入
